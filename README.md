...
1. Install Aurora Services as a system app.
   ...
   - Also if you manually push apk to `/system/priv-app`, you need to push [permissions_com.libertyphoneproject.services.xml](https://gitlab.com/AuroraOSS/AuroraServices/raw/master/app/src/main/assets/permissions_com.libertyphoneproject.services.xml) to  `/system/etc/permissions/`
